...
A cross-platform **Flutter desktop** front-end for the Android Debug Bridge, built on top of the [`adb_kit`](../) Dart package.

> Following the spec in [`docs/ADB_VISION_PROMPT.md`](https://github.com/sbrsubuvga/ADB/blob/main/docs/ADB_VISION_PROMPT.md). This is the example app for `adb_kit` and exercises every service the package exposes.
